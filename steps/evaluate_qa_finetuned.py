...
from config import BASE_MODEL_PATH, QA_FINETUNED_MODEL_PATH, QA_FINETUNED_DATASET_PATH
...
class FineTunedModelEvaluation:
    ...
    def main(self):
        ...
        tokenizer, model, pipeline = self.load_model_and_tokenizer(BASE_MODEL_PATH, QA_FINETUNED_MODEL_PATH)

        print("Evaluating General QA...")
        general_qa = self.load_general_qa(QA_FINETUNED_DATASET_PATH)
        ...
        print("\nEvaluating MCQ QA...")
        mcq_qa = self.load_mcq_qa(QA_FINETUNED_DATASET_PATH)
